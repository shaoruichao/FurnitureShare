 ...
 */
package com.example.FurnitureShare.nohttp;
...
public class CallServer {
    ...
    public <T> void request( int what, Request<T> request, HttpListener<T> callback,
        ...
        mRequestQueue.add(what, request, new HttpResponseListener<>(request, callback, canCancel, isLoading));
    }
    public <T> void requests(BaseActivity activity, int what, Request<T> request, HttpListener<T> callback,
                            boolean canCancel, boolean isLoading) {
        mRequestQueue.add(what, request, new HttpResponseListeners<>(activity, request, callback, canCancel, isLoading));
    }
