...
import com.example.FurnitureShare.ui.activity.SuerOrderActivity;
...
//                    totalPrice += (Double.parseDouble(price1)) * product.getCount();
    ...
    public String doid = ""; //购物车id
    public String c = "";   //购物车数量
    public String leases = "";//租借时长
...
//        PostShoppingcartEdit();
    ...
    public void cartEdit(int groupPosition, int childPosition, View showCountView, boolean isChecked) {
        ...
        final AlertDialog dlg = new AlertDialog.Builder(getActivity(), R.style.MyDialogStyle).create();
        //点击空白区域消失
...
//        window.setDimAmount(0);
        ...
        Glide.with(getActivity()).load(imageUrl).into(iv_shopp);
        //商品价格
...
//                Toast.makeText(getApplicationContext(), "Amount=>  " + amount, Toast.LENGTH_SHORT).show();
        ...
        bt_sure.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (lease.equals("")) {
                    ToastUtil.showToast(getActivity(), "请选择租期");
                    return;
                }
